  ...
  <div id="our-beginning" class="page-section" data-matching-link="#our-beginning-link">
    <div class="wrapper">
      ...
      <div class="wrapper wrapper--medium wrapper--b-margin">
        <img class="lazyload" sizes="(min-width: 970px) 976px, 100vw" data-srcset="/docs/assets/images/first-trip-low-res.jpg 565w, /docs/assets/images/first-trip.jpg 976w, /docs/assets/images/first-trip-hi-dpi.jpg 1952w" alt="Couple walking down a street.">
      </div>

      <div class="row row--gutters">
        <div class="row__medium-4 row__medium-4--larger row__b-margin-until-medium">
          <picture>
            <source sizes="404px" data-srcset="/docs/assets/images/our-start.jpg 404w, /docs/assets/images/our-start-hi-dpi.jpg 808w" media="(min-width: 1020px)">
            <source sizes="320px" data-srcset="/docs/assets/images/our-start-portrait.jpg 382w, /docs/assets/images/our-start-portrait-hi-dpi.jpg 764w" media="(min-width: 800px)">
            <img class="lazyload" data-srcset="/docs/assets/images/our-start-landscape.jpg 800w, /docs/assets/images/our-start-landscape-hi-dpi.jpg 1600w" alt="Our founder, Jane Doe">
          </picture>
        </div>
    ...
    <div class="wrapper wrapper--no-padding-until-large">
      ...
      <div class="row row--gutters row--equal-height-at-large row--gutters-small row--t-padding generic-content-container">
        <div class="row__large-4">
          <div class="testimonial">
            <div class="testimonial__photo">
              <img class="lazyload" sizes="160px" data-srcset="/docs/assets/images/testimonial-jane.jpg 160w, /docs/assets/images/testimonial-jane-hi-dpi.jpg 320w" alt="Jane Doe">
            </div>
        ...
        <div class="row__large-4">
          <div class="testimonial">
            <div class="testimonial__photo">
              <img class="lazyload" sizes="160px" data-srcset="/docs/assets/images/testimonial-john.jpg 160w, /docs/assets/images/testimonial-john-hi-dpi.jpg 320w" alt="John Smith">
            </div>
        ...
        <div class="row__large-4">
          <div class="testimonial testimonial--last">
            <div class="testimonial__photo">
              <img class="lazyload" sizes="160px" data-srcset="/docs/assets/images/testimonial-cat.jpg 160w, /docs/assets/images/testimonial-cat-hi-dpi.jpg 320w" alt="Cat McKitty">
            </div>
